...
function SunIcon(props) {
  return (
    ...
    >
      <path
        d="M8 12.25A4.25 4.25 0 0 1 12.25 8v0a4.25 4.25 0 0 1 4.25 
...
function MobileNavigation(props) {
  ...
  return (
    <Popover {...props}>
      ...
      bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 
      ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 
      dark:ring-white/10 dark:hover:ring-white/20"
      >
        Menu
        <ChevronDownIcon
          className="ml-3 h-auto w-2 stroke-zinc-500 
      ...
      <Transition.Root>
        ...
        >
          <Popover.Overlay
            className="fixed inset-0 z-50 bg-zinc-800/40 
        ...
        >
          <Popover.Panel
            focus
            className="fixed inset-x-4 top-8 z-50 origin-top rounded-3xl bg-white 
...
function DesktopNavigation(props) {
  ...
  return (
    <nav {...props}>
      <ul
        className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg 
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      className="group ml-2 rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-zinc-800/5 
      ring-1 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
      onClick={toggleMode}
    >
      <SunIcon
...
function LanguageToggle() {
  ...
  return (
    <button
      type="button"
      aria-label={`Toggle language (${currentLanguage.toUpperCase()})`}
      className={`group rounded-full bg-white/90 px-3 py-2 text-xs shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5
       backdrop-blur transition dark:bg-zinc-800/90 dark:text-zinc-100 dark:hover:ring-white/10`}
